...
import '../Screens/StandingsScreen.dart';
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                // Navigasi ke halaman StandingsScreen saat kartu ditekan
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => StandingsScreen(
                      code: league['code']!, // Mengirimkan kode liga ke halaman StandingsScreen
                    ),
                  ),
                );
              },
...
// Data liga yang ditampilkan di grid
